...
<head>
    ...
    <title><?= $title ?? 'Modifier Barème' ?></title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-edit"></i> Modifier le barème de frais</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="/index.php/operateur/bareme/update/<?= $bareme['id'] ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <a href="/index.php/operateur/baremes" class="btn btn-secondary">
